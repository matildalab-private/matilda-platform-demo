...
load_train_data_op = components.load_component_from_file('./component-files/load_train_data_component.yaml')
...
train_model_op = components.load_component_from_file('./component-files/train_model_component.yaml')

load_test_img_op = components.load_component_from_file('./component-files/load_test_img_component.yaml')

test_op = components.load_component_from_file('./component-files/test_component.yaml')
